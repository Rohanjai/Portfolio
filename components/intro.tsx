  ...
  return (
    ...
    >
      ...
      >
        ...
        building{" "}
        <span className="italic">sites, apps & deep learning models</span>. My
        focus is <span className="underline">Deep Learning</span>.
      </motion.h1>
      <motion.div
      ...
      >
        ...
        hover:scale-[1.15] active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.linkedin.com/in/rohanjaid/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        <a
          className="bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] 
        hover:scale-[1.15] active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.github.com/Rohanjai"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
